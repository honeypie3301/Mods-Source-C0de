...
import net.mcreator.thebackwoods.procedures.FractusOnEntityTickUpdateProcedure;
import net.mcreator.thebackwoods.procedures.FractusNaturalEntitySpawningConditionProcedure;
import net.mcreator.thebackwoods.procedures.FractusEntityIsHurtProcedure;
import net.mcreator.thebackwoods.init.TheBackwoodsModEntities;

public class FractusEntity extends Monster {
	public static final EntityDataAccessor<Boolean> DATA_play_hurt_anim = SynchedEntityData.defineId(FractusEntity.class, EntityDataSerializers.BOOLEAN);
	public final AnimationState animationState0 = new AnimationState();
	public final AnimationState animationState1 = new AnimationState();

	public FractusEntity(EntityType<FractusEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public boolean hurt(DamageSource damagesource, float amount) {
		...
		FractusEntityIsHurtProcedure.execute(world, entity);
	...
	public void baseTick() {
		super.baseTick();
		FractusOnEntityTickUpdateProcedure.execute();
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(TheBackwoodsModEntities.FRACTUS.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
			return FractusNaturalEntitySpawningConditionProcedure.execute(world, x, y, z);
