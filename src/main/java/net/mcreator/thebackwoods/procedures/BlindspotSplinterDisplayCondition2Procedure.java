...
public class BlindspotSplinterDisplayCondition2Procedure {
	public static boolean execute(Entity entity) {
		...
		if ((entity instanceof BlindspotSplinterEntity _datEntI ? _datEntI.getEntityData().get(BlindspotSplinterEntity.DATA_Age) : 0) >= 72000
				&& (entity instanceof BlindspotSplinterEntity _datEntI ? _datEntI.getEntityData().get(BlindspotSplinterEntity.DATA_Age) : 0) < 144000) {
			return true;
		}
		return false;
	}
