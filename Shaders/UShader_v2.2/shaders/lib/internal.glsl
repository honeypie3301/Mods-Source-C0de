...
#define blocklightBaseMult pi

#define netherSkylightColor vec3(1.0, 0.23, 0.08)
#define endSkylightColor vec3(0.4, 0.25, 1.0)
#define endSunlightColor vec3(1.0, 0.4, 0.7)
#define RColor_Lightmap vec3(1.0 * blocklightRedMult, 0.38 * blocklightGreenMult, 0.12 * blocklightBlueMult)
