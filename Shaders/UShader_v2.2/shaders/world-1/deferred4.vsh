...
void main() {
    ...
    BlocklightColor = RColor_Lightmap * blocklightIllum * blocklightBaseMult;
    AmbientColor  = netherSkylightColor;
    AmbientColor  = mix(AmbientColor, LinearToRec2020(normalize(toLinear(fogColor))), 0.9) * 0.3;
}