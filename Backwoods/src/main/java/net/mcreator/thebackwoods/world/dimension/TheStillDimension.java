...
public class TheStillDimension {
	@EventBusSubscriber(Dist.CLIENT)
	public static class TheStillSpecialEffectsHandler {
		@SubscribeEvent
		public static void registerDimensionSpecialEffects(RegisterDimensionSpecialEffectsEvent event) {
			...
			event.register(ResourceLocation.parse("the_backwoods:the_still"), customEffect);
		}
	}
}